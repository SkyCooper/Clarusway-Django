...
class TodoForm(forms.ModelForm):
    class Meta:
        ...
        # fields = '__all__'
        exclude = [] # bunun boş olması aslında __all__ ile aynı anlama gelir.


#* https://docs.djangoproject.com/en/4.1/topics/forms/
#! burada önemli bir özellik Django Form validasyonu kendisi yapıyor,
# yani bu örnek için konuşursak title girmek zorunlu ve max 100 karakter geçemez,
# priority alanı sadece sayı girilebilir vs.
